		...
		<div class="col-md-9">
			...
			<div class="border">
				...
				<form class="m-3" action="/applyjob/save" method="POST"
					...
					<div class="form-group">
						<input type="hidden" class="form-control" id="jobLength"
							name="jobLength" value="${jobPost.jobLength}">
					</div>
					<div class="form-row">
					...
					<button type="submit" class="btn btn-success btn-submit mt-3 mb-4">Submit</button>
				</form>
			</div>
		</div>
