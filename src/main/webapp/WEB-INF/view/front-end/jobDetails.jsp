...
<div class="container mt-5">
	<form action="/freelancer/savedjob" method="post">
		<div class="row  mb-5">
			...
			<div class="col-md-8">
				...
				<div class="job-wrap  p-3">
					...
					<div class="row">
						<div class="col-md-4">
							<h6>
								<i class="fa-solid fa-clock pr-2"></i>Less than
								${jobPost.jobLength}
							</h6>
						...
						<div class="col-md-4">
							<h6>
								<i class="fa-solid fa-clock-rotate-left pr-2"></i>$${jobPost.budget}
							</h6>
					...
					<div>
						...
						<p class="job-details-text ">Last viewed by client: 3 hours
							age</p>
			...
			<div class="col-md-4 ">
				<div class=" signup mt-5 pb-2">

					<h4>Create a free profile to find work like this</h4>
					<div class=" mt-5 mb-3">
						<button type="button" class="google-btn rounded-pill">
							<img class="google-icon" src="/resources/images/google.png">Sign
							in with Google
						</button>
					</div>
					<p class="ml-4" style="color: gray;">__________________ or
						__________________</p>
					<div class="form-group  mt-4">
						<input style="width: 100%;" type="text" class="form-control"
							id="email" name="email" placeholder="Enter work email address ">
					</div>
					<button type="submit" style="width: 100%;"
						class="btn btn-success rounded-pill btn-width mt-3 mb-4">Sign
						Up</button>
					<hr>
					<h4>Hiring for similar work?</h4>
					<div class="form-group  mt-3">
					<button type="submit" style="width: 100%;"
						class="btn btn-outline-success rounded-pill btn-width mt-3 mb-4">Post a job Like This</button>
<!-- 						
					</div>
					<!-- 					<div class="d-flex justify-content-between"> -->
					<!-- 					<p style="color: gray;">_____________</p> -->
					<!-- 					or -->
					<!-- 					<p style="color: gray;">_____________</p> -->
					<!-- 				</div> -->
